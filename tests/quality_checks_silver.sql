...
===============================================================================
Objetivo do Script:
    Este script executa diversas verificações de qualidade para consistência, 
    precisão e padronização dos dados na camada 'silver'. Inclui verificações de:
...
-- ====================================================================
-- Verificar NULOS ou Duplicados na Chave Primária
...
-- Verificar NULOS ou Valores Negativos no Custo
-- Expectativa: Nenhum Resultado
SELECT 
    prd_cost 
FROM silver.crm_prd_info
...
-- Verificar Ordens de Data Inválidas (Data de Início > Data de Fim)
-- Expectativa: Nenhum Resultado
SELECT 
    * 
FROM silver.crm_prd_info
...
-- Verificar Ordens de Data Inválidas (Data do Pedido > Datas de Envio/Vencimento)
-- Expectativa: Nenhum Resultado
SELECT 
    * 
...
-- Verificar Consistência dos Dados: Sales = Quantity * Price
-- Expectativa: Nenhum Resultado
SELECT DISTINCT 
    sls_sales,
    sls_quantity,
...
-- ====================================================================
-- Identificar Datas Fora do Intervalo Esperado
