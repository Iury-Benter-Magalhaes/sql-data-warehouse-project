/*
===============================================================================
Stored Procedure: Carregar Camada Bronze (Origem -> Bronze)
===============================================================================
Propósito do Script:
    Esta stored procedure carrega dados no schema 'bronze' a partir de
    arquivos CSV externos.
    Ela realiza as seguintes ações:
    - Trunca as tabelas bronze antes de carregar os dados.
    - Usa o comando 'BULK INSERT' para carregar dados dos arquivos csv
